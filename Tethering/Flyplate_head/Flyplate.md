...
[![Open GitHub folder]({{site.baseurl}}/assets/img/GitHub-Mark-32px.png) to GitHub project folder](https://github.com/reiserlab/Component-Design/tree/main/Tethering/Flyplate_head){:.ifr}
...
![Fly Plate 5 machined]({{site.baseurl}}/assets/img/Tethering/Flyplate/Flyplate5.png){:.ifr .pop}
...
![Fly Plate 5 machined]({{site.baseurl}}/assets/img/Tethering/Flyplate/Flyplate5_machined_01_2018.jpg){:.ifr .pop}
...
![Fly Plate 5 3D printed on the Connex machine]({{site.baseurl}}/assets/img/Tethering/Flyplate/Flyplate5_connex_03_2019-11.jpg){:.ifr .pop}
