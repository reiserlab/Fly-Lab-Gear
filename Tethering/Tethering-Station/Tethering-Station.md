...
![Draft for a 3D printed tethering station]({{site.baseurl}}/assets/img/Tethering/Tethering-Station/Tethering-Station_print.png){:.ifr .pop}
`Tethering-Station_print.FCStd`: Before the laser-cut version, we first designed a 3D model with the intention to print it. At the end this design would have used too much material to be recommended in our [Inexpensive Treadmill manuscript]({{site.baseurl}}/inexpensive-treadmill).