...
[![Open GitHub folder]({{site.baseurl}}/assets/img/GitHub-Mark-32px.png) → to GitHub project folder](https://github.com/reiserlab/Component-Design/tree/main/Experimental-Setup/Square_wells_90mm){:.ifr}
...
![Square Wells]({{site.baseurl}}/assets/img/Experimental-Setup/Square_wells_90mm/Wells_3x3_optogenetics.png){: .ifr .pop}
