...
[![Open GitHub folder]({{site.baseurl}}/assets/img/GitHub-Mark-32px.png) → to GitHub project folder](https://github.com/reiserlab/Component-Design/tree/main/Support/Baseplate){:.ifr}
...
![Baseplate model]({{site.baseurl}}/assets/img/Support/Baseplate/Baseplate.png){: .ifr .pop}
...
![]({{site.baseurl}}/assets/img/Support/Baseplate/Baseplate_sketch.png){:.ifr .pop}
...
![]({{site.baseurl}}/assets/img/Support/Baseplate/Heating-Base.png){:.ifr .pop}
