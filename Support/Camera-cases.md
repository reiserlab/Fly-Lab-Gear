...
[![Open GitHub folder]({{site.baseurl}}/assets/img/GitHub-Mark-32px.png) → to GitHub project folder](https://github.com/reiserlab/Component-Design/tree/main/Support/Case_Camera_Basler){:.ifr}
This is the back side of a case for a small board camera. It includes a 90° screw hole.

![Basler camera case]({{site.baseurl}}/assets/img/Support/Case_Camera_Basler/Case_Camera_Basler.png){:.ifr .pop}
...
[![Open GitHub folder]({{site.baseurl}}/assets/img/GitHub-Mark-32px.png) → to GitHub project folder](https://github.com/reiserlab/Component-Design/tree/main/Support/Case_Cable-Camera_Misumi){:.ifr}
...
![Misumi cable camera case]({{site.baseurl}}/assets/img/Support/Case_Cable-Camera_Misumi/Case_Cable-Camera.png){:.ifr .pop}
