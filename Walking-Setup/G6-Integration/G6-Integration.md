...
This section collects the components we designed or modified for that integration: a taller fly holder, a taller resin-printed integrated camera-and-treadmill, a PCB-mounted optogenetic stimulation rail, load-bearing posts between the arena panels, and a consolidated 12 V electrical control box. Near-infrared illumination for the FicTrac camera is provided by our  [Illumination PCB]({{site.baseurl}}/walking/illumination-pcb).
...
[![Optostimulation rail]({{site.baseurl}}/assets/img/G6-Arena-Integration/Optostimulation/Optostimulation.png){:.ifr}]({{site.baseurl}}/g6/optostimulation)
...
[![12 V electrical control box]({{site.baseurl}}/assets/img/G6-Arena-Integration/Electrical-Box-12V/Electrical-Box-12V.png){:.ifr}]({{site.baseurl}}/g6/electrical-box)
