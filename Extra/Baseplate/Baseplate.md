...
[![Open GitHub folder]({{"/assets/img/GitHub-Mark-32px.png" | relative_url}}) → to GitHub project folder](https://github.com/reiserlab/Component-Design/tree/main/Extra/Baseplate){:.ifr}
...
![Baseplate model]({{"/assets/img/Extra/Baseplate/Baseplate.png" | relative_url}}){: .ifr .pop}
...
![]({{"/assets/img/Extra/Baseplate/Baseplate_sketch.png" | relative_url }}){:.ifr .pop}
...
![]({{"/assets/img/Extra/Baseplate/Heating-Base.png" | relative_url }}){:.ifr .pop}
